...
export const projects = [
    {
        ...
        details: "It's a website in which the African Leadership College students can engage with video and article resources based on how they are currently feeling. This helps the students to assist their emotional wellbeing and get help from the team of wellness and peer counsellors. It's created using HTML, CSS and Javascript language."
    },
    {
        id: 2,
